...
public class GlobalExceptionHandler {
        ...
        public ResponseEntity<String> invalidCredentials(InvalidPasswordException ex){
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("your password is incorrect please try again !!");
        }

        // EmailAlreadyExistsExceptionglobal handler
        @ExceptionHandler(EmailAlreadyExistsException.class)
        public ResponseEntity<String> invalidCredentials( EmailAlreadyExistsException ex){
